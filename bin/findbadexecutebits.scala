...
val executableExtensions =
  "pl py sh rb dll so jnilib command"
val executableFullNames =
  "bitten/startslave MacOS/HubNet MacOS/NetLogo bin/scala bin/scalac bin/sbt bin/scaladoc"
val nonExecutableExtensions =
  ...
  "aif au ogg wav dat bsearch mf properties nbm java_NEW psd iml gitignore ensime"
