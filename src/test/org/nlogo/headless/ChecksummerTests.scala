...
class ChecksummerTests extends FunSuite {
  ...
  test("one section") {
    ...
    expect("41ECD0D21169ED248C8499E22CF3CF636F5DADC1")(
  ...
  test("two sections") {
    ...
    expect("046F28A95D201F85B8C5664C36FDECF24D23213D")(
      Checksummer.calculateChecksum(tester _))
  }
  test("three sections") {
    def tester(fn: PrintWriter) {
    ...
    expect("EA4F5E16376F2FC7242F9BF28328CC00B5A8190D")(
      Checksummer.calculateChecksum(tester _))
  }
  test("two empty sections") {
    ...
    expect("376368FF0F759FD60F473E56EA58D5E7D8305E0F")(
      Checksummer.calculateChecksum(tester _))
  }
}
