			   ...
			   org.nlogo.api.ViewSettings
{
	...
	public AggregateManagerInterface aggregateManager() { return aggregateManager ; }

	private final RendererInterface renderer ;
	public RendererInterface renderer() { return renderer ; }

	private final CompilerInterface compiler ;
	@Override public CompilerInterface compiler() { return compiler ; }
	...
	void silent( boolean silent ) { this.silent = silent ; }
	...
	public String tickCounterLabel() { return "ticks" ; }
	public void showTickCounter( boolean visible ) {}
	public boolean showTickCounter() { return true ; }
	public void frameRate( double rate ) { }
	public double frameRate() { return 0.0 ; }

	public int getWidth() { return (int) StrictMath.round( world.worldWidth() * world.patchSize() ) ; }
	public int getHeight() { return (int) StrictMath.round( world.worldHeight() * world.patchSize() ) ; }
	// for now we don't have different view sizes headless.
	public double viewWidth() { return world.worldWidth() ; }
	public double viewHeight() { return world.worldHeight() ; }
	...
	public Perspective perspective() { return world.observer().perspective() ; }
	public boolean drawSpotlight() { return true ; }
	public boolean renderPerspective() { return true ; }
	public double viewOffsetX() {return world.observer().followOffsetX() ; }
	public double viewOffsetY() { return world.observer().followOffsetY() ; }

	// we shouldn't need "Workspace." lampsvn.epfl.ch/trac/scala/ticket/1409 - ST 4/6/09
	@Override public void updateMode( Workspace.UpdateMode updateMode )
	{
		// ignore
	}
	...
	{
		if(hubnetManager() != null ) { hubnetManager().incrementalUpdateFromEventThread(); } 
	}
  ...
  /**
	 ...
	 * Internal use only.
	 */
	@Override public LogoException lastLogoException()
	{
	 ...
	 * Internal use only.
	 */
	@Override public void clearLastLogoException()
	{
