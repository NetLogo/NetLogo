...
public final strictfp class AgentVariables {
	// Turtle variables
	...
	private AgentVariables() { throw new IllegalStateException() ; }
	public static String[] getImplicitObserverVariables() { return new String[] { } ; }
	public static String[] getImplicitTurtleVariables( boolean is3D ) {
		return is3D
			? new String[] { "WHO","COLOR","HEADING","PITCH", "ROLL","XCOR","YCOR","ZCOR","SHAPE" ,
							 "LABEL","LABEL-COLOR","BREED","HIDDEN?","SIZE","PEN-SIZE","PEN-MODE" }
		    : new String[] { "WHO","COLOR","HEADING","XCOR","YCOR","SHAPE","LABEL","LABEL-COLOR","BREED" ,
                             "HIDDEN?","SIZE","PEN-SIZE","PEN-MODE"} ;
	}
	public static String[] getImplicitPatchVariables( boolean is3D ) {
		return is3D
		    ? new String[] { "PXCOR","PYCOR","PZCOR","PCOLOR","PLABEL","PLABEL-COLOR" }
			: new String[] { "PXCOR","PYCOR","PCOLOR","PLABEL","PLABEL-COLOR" } ;
	}
	public static String[] getImplicitLinkVariables() {
		return new String[] { "END1","END2","COLOR","LABEL","LABEL-COLOR","HIDDEN?","BREED",
							  "THICKNESS","SHAPE","TIE-MODE" } ;
	}

	public static boolean isDoubleTurtleVariable( int vn , boolean is3D )
	{
		if( is3D )
		{
			return
	...
	public static boolean isSpecialTurtleVariable( int vn )
	{
		return vn == VAR_WHO ;
	}

	public static boolean isDoublePatchVariable( int vn , boolean is3D )
	{
		if( is3D )
		{
			return 
	...
	public static boolean isSpecialPatchVariable( int vn , boolean is3D )
	{
		if( is3D )
		{
			return 
	...
	public static boolean isDoubleLinkVariable( int vn )
	{
		return vn == VAR_THICKNESS ;
	}

	public static boolean isSpecialLinkVariable( int vn )
	{
		return vn == VAR_END1 || vn == VAR_END2 || vn == VAR_LBREED ;
	}
}
