	...
	implements org.nlogo.window.Events.OpenModelEvent.Handler
{
	...
	{
		NewAction() { super( I18N.gui().get("menu.file.new")  ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
	...
	{
		OpenAction() { super( I18N.gui().get("menu.file.open") ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
	...
	{
		ModelsLibraryAction() { super( I18N.gui().get("menu.file.modelsLibrary") ) ; }
		@Override
		void action()
	...
	{
		SaveAction() { super( I18N.gui().get("menu.file.save") ) ; }
		@Override
		void action()
			throws UserCancelException
		{
	...
	{
		SaveAsAction() { super( I18N.gui().get("menu.file.saveAs") ) ; }
		@Override
		void action()
			throws UserCancelException
		{
	...
	public javax.swing.AbstractAction saveClientAppletAction() { return new SaveClientAppletAction() ; }
	...
	{
		ExportWorldAction() { super( I18N.gui().get("menu.file.export.world") ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
	...
	{
		ExportGraphicsAction() { super( I18N.gui().get("menu.file.export.view") ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
	...
	{
		ExportInterfaceAction() { super( I18N.gui().get("menu.file.export.interface")  ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
	...
	{
		ExportOutputAction() { super( I18N.gui().get("menu.file.export.output")  ) ; }
		@Override
		void action()
			throws UserCancelException
		{
	...
	{
		ExportPlotAction() { super( I18N.gui().get("menu.file.export.plot") ) ; }
		@Override
		void action()
			throws UserCancelException
		{
				  ...
				  new Runnable() {
					  public void run() {
						  new org.nlogo.window.Events.ExportPlotEvent
							  ( org.nlogo.window.PlotWidgetExportType.PROMPT ,
								null , exportPath )
							  .raise( FileMenu.this ) ;
					  } } ,
				  "Exporting..." ) ;
	...
	{
		ExportAllPlotsAction() { super( I18N.gui().get("menu.file.export.allPlots")  ) ; }
			...
			new org.nlogo.swing.ModalProgressTask
				( org.nlogo.awt.Utils.getFrame( FileMenu.this ) ,
				  new Runnable() {
					  public void run() {
						  new org.nlogo.window.Events.ExportPlotEvent
							  ( org.nlogo.window.PlotWidgetExportType.ALL ,
								null , exportPath )
							  .raise( FileMenu.this ) ;
					  } } ,
				  "Exporting..." ) ;
	...
	{
		ImportWorldAction() { super( I18N.gui().get("menu.file.import.world")  ) ; }
	...
	{
		ImportPatchColorsAction() { super( I18N.gui().get("menu.file.import.patchColors")  ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
				...
				( org.nlogo.awt.Utils.getFrame( FileMenu.this ) ,
				  new Runnable() {
					  public void run() {
						  try
						  {
							  // We can't wait for the thread to
							  // complete, or we end up locking up the
							  // app since the Model Dialog and the
	...
	{
		ImportPatchColorsRGBAction() { super( I18N.gui().get("menu.file.import.patchColorsRGB")  ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
	...
	{
		ImportDrawingAction() { super( I18N.gui().get("menu.file.import.drawing")  ) ; }
		@Override
		void action()
			throws UserCancelException , java.io.IOException
		{
	...
	{
		ImportClientAction() { super( I18N.gui().get("menu.file.import.hubNetClientInterface") ) ; }
		@Override
		void action()
			throws UserCancelException, java.io.IOException
		{
	...
	{
		QuitAction() { super( I18N.gui().get("menu.file.quit") ) ; }
		@Override
		void action()
		{
			try
							  ...
							  final ModelType modelType )
	{
		try
		{
			...
			else
			{
				...
				new org.nlogo.swing.ModalProgressTask
					( org.nlogo.awt.Utils.getFrame( this ) , loader , message ) ;
	...
	private class Saver implements Runnable
	{
		...
		java.io.IOException getException() { return exception ; }
		...
		throws UserCancelException
	{
		...
		new org.nlogo.swing.ModalProgressTask
			( org.nlogo.awt.Utils.getFrame( this ) , saver ,
			"Saving..." ) ;
