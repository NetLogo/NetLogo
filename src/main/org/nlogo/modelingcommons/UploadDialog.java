...
public class UploadDialog extends JDialog {
  ...
  UploadDialog(final Frame frame, final ModelingCommons communicator, String errorLabelText, boolean enableAutoGeneratePreviewImage) {
    ...
    logoutButton.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        dispose();
        Request request = new LogoutRequest(communicator.getHttpClient(), frame) {
          @Override
          protected void onLogout(String status, boolean logoutSuccessful) {
            if(logoutSuccessful) {
              communicator.setPerson(null);
            }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    childOfExistingModelRadioButton = new JRadioButton();
    childOfExistingModelRadioButton.setText("Child of existing model");
    panel1.add(childOfExistingModelRadioButton, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    newVersionOfExistingRadioButton = new JRadioButton();
    newVersionOfExistingRadioButton.setText("New version of existing model");
    panel1.add(newVersionOfExistingRadioButton, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    ...
    existingModelNameLabel = new JLabel();
    existingModelNameLabel.setText("Existing Model Name");
    panel1.add(existingModelNameLabel, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    ...
    panel1.add(existingModelNameSearchField, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
    existingModelNameComboBox = new DisableableComboBox();
    panel1.add(existingModelNameComboBox, new GridConstraints(6, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
