	...
	implements org.nlogo.api.Shape , Cloneable , java.io.Serializable , DrawableShape
{
	...
	public LinkLine getLine( int i ) { return lines[ i ] ; } 
	...
	public double curviness() { return curviness ; }
	public void curviness( double curviness ) { this.curviness = curviness ; }
	...
	public int getEditableColorIndex() { return 0 ; }
