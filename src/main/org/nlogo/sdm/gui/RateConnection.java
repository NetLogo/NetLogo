			   ...
			   org.nlogo.api.Editable
{
    ...
    public Exception error(Object key){ return null; }
	...
	public String classDisplayName() { return "Flow"; }
	public boolean editFinished() { return true ; }
	...
	public String nameWrapper( ) { return rate.getName( ) ; }
	...
	public String expressionWrapper( ) { return rate.getExpression( ) ; }
	...
	public boolean bivalentWrapper( ) { return rate.isBivalent() ; }
