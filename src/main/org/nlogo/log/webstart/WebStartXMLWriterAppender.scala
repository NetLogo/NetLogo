...
/*
 The `LogProxyWriter` pretty much needs to be a default param in a sneaky second parameter list here, because:
   a) I don't want the user of this class to worry about constructing `LogProxyWriter`s
