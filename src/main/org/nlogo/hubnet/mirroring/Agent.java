...
public strictfp class Agent
{
	...
	enum AgentType
	{
		...
		{
			if( agentClass == null ) { return OBSERVER ; } // don't know why this seems to be necessary - ST 2/25/09
			if( org.nlogo.api.Turtle.class.isAssignableFrom( agentClass ) ) { return TURTLE ; }
			else if( org.nlogo.api.Patch.class.isAssignableFrom( agentClass ) ) { return PATCH ; }
			else if( org.nlogo.api.Link.class.isAssignableFrom( agentClass ) ) { return LINK ; }
