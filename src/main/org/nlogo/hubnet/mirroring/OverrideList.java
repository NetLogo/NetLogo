	...
	implements java.io.Serializable
{
	...
	private int getOverrideIndex( AgentType type , String varName )
	{
		switch( type )
		{
		    case TURTLE: return TurtleData.getOverrideIndex( varName ) ; 
		    case PATCH: return PatchData.getOverrideIndex( varName ) ; 
		    case LINK: return LinkData.getOverrideIndex( varName ) ; 
