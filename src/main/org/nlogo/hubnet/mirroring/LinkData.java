	...
	implements org.nlogo.api.Link
{
	...
	@Override public double xcor()
	{
		return midpointX() ;	   
	}
	@Override public double ycor()
	{
		return midpointY() ;
	}
	@Override public double spotlightSize() 
	{
		return 1 ;
	}
	@Override public boolean wrapSpotlight()
	{
		return false ;
	}
	...
	@Override public String getMethodName( int index )
	{
