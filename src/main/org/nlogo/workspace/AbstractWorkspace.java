	...
	org.nlogo.agent.Evaluator
{
	...
	public org.nlogo.agent.World world() { return world ; }
	...
	public org.nlogo.nvm.Tracer profilingTracer() { return tracer ; }

    public boolean profilingEnabled() { return tracer != null ; }
	public void setProfilingTracer( org.nlogo.nvm.Tracer tracer ) { this.tracer = tracer ; }
	...
	public WeakHashMap<Job,WeakHashMap<Agent,WeakHashMap<Command,MutableLong>>> lastRunTimes() { return lastRunTimes ; }
    ...
    public WeakHashMap<Activation, Boolean> completedActivations(){ return completedActivations; }
		...
		throws InterruptedException
	{
		...
		jobManager.die() ;
        if( hubNetManager != null ){ hubNetManager.disconnect(); }
	}
	...
	public static boolean isApp() { return isApp ; }
	public static void isApp( boolean isApp ) { AbstractWorkspace.isApp = isApp ; }
	
	private static boolean isApplet = true ;
	public static boolean isApplet() { return isApplet ; }
	public static void isApplet( boolean isApplet ) { AbstractWorkspace.isApplet = isApplet ; }
	...
	public boolean hubNetRunning() { return hubNetRunning ; }
  ...
  public abstract void changeLanguage() ;
	...
	public Workspace.UpdateMode updateMode() { return updateMode ; }
	...
	protected abstract class FileImporter
	{
		...
		FileImporter( String filename ) { this.filename = filename ; }
	...
	public int behaviorSpaceRunNumber() { return _behaviorSpaceRunNumber ; }
	public void behaviorSpaceRunNumber( int n )	{ _behaviorSpaceRunNumber = n ; }
