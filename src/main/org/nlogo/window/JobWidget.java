	...
	org.nlogo.window.Events.CompiledEvent.Handler
{
	...
	public Class<? extends Agent> agentClass() { return agentClass ; }
	public void agentClass( Class<? extends Agent> agentClass ) { this.agentClass = agentClass ; }
	
	public final org.nlogo.util.MersenneTwisterFast random ;

	public org.nlogo.util.MersenneTwisterFast random() { return random ; }
	...
	public org.nlogo.agent.AgentSet agents() { return agents ; }
	public void agents( org.nlogo.agent.AgentSet agents ) { this.agents = agents ; }
	
	private org.nlogo.nvm.Procedure procedure = null ;
	public org.nlogo.nvm.Procedure procedure() { return procedure ; }
	public void procedure( org.nlogo.nvm.Procedure procedure ) { this.procedure = procedure ; }
	...
	public String innerSource() { return innerSource; }
	public void innerSource( String innerSource ) { this.innerSource = innerSource ; }
	
	protected String headerSource = "" ;
	public String headerSource() { return headerSource; }
	public void headerSource( String headerSource ) { this.headerSource = headerSource ; }
	
	protected String footerSource = "" ;
	public String footerSource() { return footerSource ; }
	public void footerSource( String footerSource ) { this.footerSource = footerSource ; }
