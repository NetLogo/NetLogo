			   ...
			   org.nlogo.api.WorldPropertiesInterface
{
	...
	public String classDisplayName() { return "Model Settings" ; }
	...
	public boolean smooth() { return workspace.glView.antiAliasingOn() ; }
	...
	public boolean wireframe() { return workspace.glView.wireframeOn() ; }
    ...
    public scala.Option<String> helpLink(){ return scala.Option.apply(null); }
    ...
    public boolean anyErrors(){ return error != null; }
    public void error(Exception e) {
        if(e instanceof CompilerException){ error = (CompilerException) e; }
        else{ throw new IllegalStateException(e); }
    }
    public void error(Object o, Exception e) { error(e); }
	public Exception error(){ return error ; }
    public Exception error(Object o){ return error; }
