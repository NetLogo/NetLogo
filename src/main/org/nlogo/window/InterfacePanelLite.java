	...
	org.nlogo.window.Events.OutputEvent.Handler
{
	...
	public ViewWidgetInterface viewWidget() { return viewWidget ; }
    ...
    protected java.awt.event.KeyAdapter getKeyAdapter() { return new ButtonKeyAdapter(); }
    ...
    protected class ButtonKeyAdapter extends java.awt.event.KeyAdapter {
        ...
        @Override public void keyTyped(java.awt.event.KeyEvent e) {
            if (keyIsHandleable(e)) {
                ...
                if (button != null) { buttonKeyed(button); }
            }
        }
        public void buttonKeyed(ButtonWidget button){  button.keyTriggered(); }
    }
	...
	public boolean sliderEventOnReleaseOnly() { return sliderEventOnReleaseOnly ; }
	...
	public Widget loadWidget( String[] strings , final String modelVersion )
	{
		Widget.LoadHelper helper =
			new Widget.LoadHelper() {
				public String version() { return modelVersion ; }
