	...
	org.nlogo.api.DrawingInterface
{
	...
	public double frameRate() { return _frameRate ; }
	...
	public boolean sendPixels() { return view.renderer.trailDrawer().sendPixels() ; }
	public void sendPixels( boolean dirty ) { view.renderer.trailDrawer().sendPixels( dirty ) ; }
  ...
  // called from the job thread
	...
	public boolean dualView() { return dualView ; }
	...
	public int [] colors() { return view.renderer.trailDrawer().colors() ; }
	public boolean isDirty() { return view.renderer.trailDrawer().isDirty() ; }
	public boolean isBlank() { return view.renderer.trailDrawer().isBlank() ; }
	public void markClean() { view.renderer.trailDrawer().markClean() ; }
	public void markDirty() { view.renderer.trailDrawer().markDirty() ; }
	public int getWidth() { return view.renderer.trailDrawer().getWidth() ; }
	public int getHeight() { return view.renderer.trailDrawer().getHeight() ; }
	public void readImage( java.io.InputStream is ) throws java.io.IOException { view.renderer.trailDrawer().readImage( is ) ; }
	public void rescaleDrawing() { view.renderer.trailDrawer().rescaleDrawing() ; }
	...
	public void snapOn( boolean snapOn ) { this.snapOn = snapOn ; }
	public boolean snapOn() { return this.snapOn ; }
