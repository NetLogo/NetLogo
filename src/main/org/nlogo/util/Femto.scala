...
// Sometimes we need to do dependency injection in low-level packages that aren't allowed to use
// PicoContainer because PicoContainer would make the applet jars 280K heavier. So we have this
// ultra low rent alternative. - ST 3/2/09, 11/21/09
