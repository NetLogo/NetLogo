...
{	
	...
	public boolean wireframeOn() { return wireframeOn ; }
	public void wireframeOn( boolean on )
	{
		wireframeOn = on ;
	}

	public void framesSkipped() { framesSkipped = true ; }
	...
	public boolean viewIsVisible() { return currentView.isShowing() ; }
	...
	public void addLinkComponent( Object c ) { linkComponents.clear() ; linkComponents.add( c ) ; }
	public Object[] getLinkChildren() { return linkComponents.toArray() ; }
	...
	boolean warned(){ return warned ; }
	void warned( boolean warned ){ this.warned = warned ; }
}
