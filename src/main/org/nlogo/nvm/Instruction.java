	...
	implements org.nlogo.api.TokenHolder
{
	...
	public org.nlogo.api.Token token() { return token ; }
	public void token( org.nlogo.api.Token token ) { this.token = token ; }
	...
	public void tokenLimitingType( org.nlogo.api.Token token ) { this.token2 = token ; }
	...
	public Thunk<String> disassembly =
		new Thunk<String>() { @Override public String compute() { return "" ; } } ;
