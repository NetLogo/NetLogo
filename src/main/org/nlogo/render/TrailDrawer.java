...
{ 
	...
	public void setTopology( TopologyRenderer topology ){ this.topology = topology ; }

	public boolean sendPixels() { return sendPixels ; }
	public void sendPixels( boolean dirty ) { sendPixels = dirty ; }
	private boolean sendPixels = false ;

	public boolean isDirty() { return drawingDirty ; }
	public boolean isBlank() { return drawingBlank ; }
	...
	{ throw new UnsupportedOperationException() ; }
	public boolean renderPerspective() { return false ; }
