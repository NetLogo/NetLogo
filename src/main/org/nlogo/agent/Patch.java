	...
	implements org.nlogo.api.Patch
{
	...
	public Iterable<Turtle> turtlesHere() { return _turtlesHere ; }
	private final ArrayList<Turtle> _turtlesHere = new ArrayList<Turtle>( 0 ) ;
	public int turtleCount() { return _turtlesHere.size() ; }
	public void clearTurtles() { _turtlesHere.clear() ; }
	public void addTurtle( Turtle t ) { _turtlesHere.add( t ) ; }
	public void removeTurtle( Turtle t ) { _turtlesHere.remove( t ) ; }
	...
	public int pxcor() { return pxcor ; }
	public final int pycor ;
	public int pycor() { return pycor ; }
