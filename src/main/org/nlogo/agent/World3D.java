	...
	implements org.nlogo.api.World3D
{
	...
	int _worldDepth ;
	public int worldDepth() { return _worldDepth ; } 

	int _maxPzcor ;
	public int maxPzcor() { return _maxPzcor ; }
	int _minPzcor ;
	public int minPzcor()	{ return _minPzcor ; }

	Double _minPzcorBoxed ;
	public Double minPzcorBoxed() { return _minPzcorBoxed ; }
	Double _maxPzcorBoxed ;
	public Double maxPzcorBoxed() { return _maxPzcorBoxed ; }
	Double _worldDepthBoxed ;
	public Double worldDepthBoxed() { return _worldDepthBoxed ; }
