	...
	extends Importer
{
	...
	@Override void checkVersion( String versionNumber )
	...
	@Override String [] getSpecialObserverVariables()
	{
	...
	@Override String [] getSpecialTurtleVariables()
	{
	...
	@Override String [] getSpecialPatchVariables()
	{
	...
	@Override String [] getEssentialObserverVars()
	{
		return new String []
			{ MIN_PXCOR_HEADER ,
			  MAX_PXCOR_HEADER ,
	...
	@Override String [] getEssentialPatchVariables()
	{
		String [] vars = AgentVariables.getImplicitPatchVariables( true ) ;
		return new String []
			{ vars[ Patch3D.VAR_PXCOR3D ] , vars[ Patch3D.VAR_PYCOR3D ] ,
