	...
	implements org.nlogo.api.Observer
{
	...
	public void perspective( Perspective perspective ) { this.perspective = perspective ; }

    org.nlogo.api.Agent targetAgent = null ;
	public org.nlogo.api.Agent targetAgent() { return targetAgent ; }
	public void targetAgent( org.nlogo.api.Agent agent ) { targetAgent = agent ; }

	///

	double oxcor ;
	public double oxcor() { return oxcor ; }
	public void oxcor( double oxcor ) { this.oxcor = oxcor ; } 

	double oycor ;
	public double oycor() { return oycor ; }
	public void oycor( double oycor ) { this.oycor = oycor ; } 
	
	double ozcor ;
	public double ozcor() { return ozcor ; }
	public void ozcor( double ozcor ) { this.ozcor = ozcor ; }
	...
	public int followDistance() { return followDistance ; }
	public void followDistance( int followDistance ) { this.followDistance = followDistance ; }
