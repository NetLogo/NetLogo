...
sealed trait DeclaresGlobalCommand {
  def varName: String
  def default: Any
  def command: String = "set " + varName + " " + (default match {
    case s: String => s""""$s""""
...
case class Switch(display: String, left: Int = 0, top: Int = 0, right: Int = 0, bottom: Int = 0,
             varName: String, on: Boolean = false) extends Widget with DeclaresGlobal
case class Chooser(display: String, left: Int = 0, top: Int = 0, right: Int = 0, bottom: Int = 0,
             varName: String, choices: List[String] = Nil, currentChoice: Int = 0) extends Widget with DeclaresGlobal
...
case class Slider(display: String, left: Int = 0, top: Int = 0, right: Int = 0, bottom: Int = 0,
             ...
             units: String = "", direction: Direction = Horizontal) extends Widget with DeclaresGlobal with DeclaresGlobalCommand
...
case class InputBox[T](left: Int = 0, top: Int = 0, right: Int = 0, bottom: Int = 0, varName: String,
             value: T, multiline: Boolean = false, boxtype: InputBoxType[T]) extends Widget with DeclaresGlobal
