...
/**
 * Reporters should implement the Pure interface if they are constant or constant-preserving
 ...
 *
 * Specifically, ConstantFolder looks for reporters that are entirely pure.  A reporter is
