...
class WidgetWrapper(widget: Widget, val interfacePanel: WidgetPanel)
  ...
  */
  ...
  private def populateContextMenu(menu: JPopupMenu, p: Point, source: Component): Point = {
    ...
    if (selected) {
      menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.deselect")) {
        def actionPerformed(e: ActionEvent) {
          selected(false)
      ...
      if (interfacePanel.multiSelected) {
        ...
        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.alignLeft")) {
          def actionPerformed(e: ActionEvent) {
            interfacePanel.alignLeft(WidgetWrapper.this)
          }
        })

        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.alignCenterHorizontal")) {
          def actionPerformed(e: ActionEvent) {
            interfacePanel.alignCenterHorizontal(WidgetWrapper.this)
          }
        })

        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.alignRight")) {
          def actionPerformed(e: ActionEvent) {
            interfacePanel.alignRight(WidgetWrapper.this)
          }
        })

        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.alignTop")) {
          def actionPerformed(e: ActionEvent) {
            interfacePanel.alignTop(WidgetWrapper.this)
          }
        })

        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.alignCenterVertical")) {
          def actionPerformed(e: ActionEvent) {
            interfacePanel.alignCenterVertical(WidgetWrapper.this)
          }
        })

        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.alignBottom")) {
          def actionPerformed(e: ActionEvent) {
        ...
        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.distributeHorizontal")) {
          def actionPerformed(e: ActionEvent) {
            interfacePanel.distributeHorizontal()
          }
        })

        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.distributeVertical")) {
          def actionPerformed(e: ActionEvent) {
      ...
      menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.select")) {
        def actionPerformed(e: ActionEvent) {
          selected(true)
          foreground()
        }
    ...
    if (widget.hasContextMenu) {
      ...
      if (widget.exportable) {
        menu.add(new AbstractAction(I18N.gui.get("tabs.run.widget.export")) {
          def actionPerformed(e: ActionEvent) {
