...
object UserAction {
  ...
  val EditFoldSubcategory = "org.nlogo.swing.EditFoldSubcategory"
  ...
  val FilePrintGroup        = "org.nlogo.swing.FilePrintGroup"
  val FileQuitGroup         = "org.nlogo.swing.FileQuitGroup"
  ...
  val subcategoryMnemonics = Map[String, Char](
    EditFoldSubcategory -> 'O',
    FileExportSubcategory -> 'E',
    FileImportSubcategory -> 'I',
    FileRecentSubcategory -> 'R'
  )
