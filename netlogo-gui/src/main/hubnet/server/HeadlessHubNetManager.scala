...
import org.nlogo.api.{ ModelType, GenericModelLoader }
...
// but what?
class HeadlessHubNetManager(workspace: AbstractWorkspaceScala, loader: GenericModelLoader, modelConverter: ModelConversion)
