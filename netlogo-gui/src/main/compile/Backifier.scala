...
class Backifier(program: Program,
  ...
  val replacements = Map[String, String](
    ...
    "org.nlogo.prim._breedon"             -> "org.nlogo.prim._breedon",
    ...
    "org.nlogo.prim.etc._autoplot"        -> "org.nlogo.prim.plot._autoplot",
    "org.nlogo.prim.etc._autoplotx"       -> "org.nlogo.prim.plot._autoplotx",
    "org.nlogo.prim.etc._autoploty"       -> "org.nlogo.prim.plot._autoploty",
    ...
    "org.nlogo.prim.etc._autoplotxoff"    -> "org.nlogo.prim.plot._autoplotxoff",
    "org.nlogo.prim.etc._autoplotxon"     -> "org.nlogo.prim.plot._autoplotxon",
    "org.nlogo.prim.etc._autoplotyoff"    -> "org.nlogo.prim.plot._autoplotyoff",
    "org.nlogo.prim.etc._autoplotyon"     -> "org.nlogo.prim.plot._autoplotyon",
  ...
  def apply(procedures: ListMap[Tuple2[String, Option[String]], nvm.Procedure], c: core.Command): nvm.Command = {
  ...
  def apply(procedures: ListMap[Tuple2[String, Option[String]], nvm.Procedure], r: core.Reporter): nvm.Reporter = {
    val result: nvm.Reporter = r match {
      ...
      case core.prim._commandlambda(args, closedVariables, source) =>
        new nvmprim._commandlambda(args, null, closedVariables, source.getOrElse(""))
      ...
      case core.prim._callreport(proc) => {
        ...
        new nvmprim._callreport(procedures((proc.name, proc.filename)))
      }
