...
import org.nlogo.agent.{ Agent, CompilationManagement, World }
...
class LiteWorkspace(appletPanel: AppletPanel, isApplet: Boolean, world: World with CompilationManagement, frame: java.awt.Frame, listenerManager: NetLogoListenerManager, controlSet: ControlSet)
