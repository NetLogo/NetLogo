...
object TestHelper {
  ...
  private[compile] def compiledProcedures(source: String, program: Program, is3D: Boolean = false): Seq[ProcedureDefinition] = {
    val oldProceduresListMap = ListMap[Tuple2[String, Option[String]], FrontEndProcedure]()
    val oldNvmProceduresListMap = ListMap[Tuple2[String, Option[String]], org.nlogo.nvm.Procedure]()
