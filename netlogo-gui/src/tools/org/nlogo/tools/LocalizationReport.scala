...
object LocalizationReport {
  ...
  (KeyAndArgs("org.nlogo.prim.etc._turtleset.incorrectInputType", "TURTLE-SET", "[(patch 1 1) turtles]", "(patch 1 1)"),
            Some("List inputs to TURTLE-SET must only contain turtle, turtle agentset, or list elements.  The list [(patch 1 1) turtles] contained (patch 1 1) which is NOT a turtle or turtle agentset.")),
  ...
  (KeyAndArgs("org.nlogo.prim.etc._turtleset.listInputsMustBeTurtleOrTurtleAgentset", "TURTLE-SET", "[(patch 1 1) turtles]", "(patch 1 1)"),
            Some("List inputs to TURTLE-SET must only contain turtle, turtle agentset, or list elements.  The list [(patch 1 1) turtles] contained a different type agentset: (patch 1 1).")),
