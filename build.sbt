  ...
  settings(
    ...
    libraryDependencies ++= {
      ...
      Seq(
        ...
        "org.jogamp.jogl" % "jogl-all" % "2.5.0" from "https://jogamp.org/deployment/archive/rc/v2.5.0/jar/jogl-all.jar",
        "org.jogamp.gluegen" % "gluegen-rt" % "2.5.0" from "https://jogamp.org/deployment/archive/rc/v2.5.0/jar/gluegen-rt.jar",
