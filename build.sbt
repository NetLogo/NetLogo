...
libraryDependencies ++= Seq("asm" % "asm-all" % "3.3.1",
                            ...
                            "org.parboiled" % "parboiled-java" % "1.0.1",
                            ...
                            "ch.randelshofer" % "quaqua" % "7.4.2" from "http://ccl.northwestern.edu/devel/quaqua-7.4.2.jar",
                            "ch.randelshofer" % "swing-layout" % "7.4.2" from "http://ccl.northwestern.edu/devel/swing-layout-7.4.2.jar",
