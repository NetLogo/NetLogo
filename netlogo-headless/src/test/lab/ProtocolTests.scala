...
class ProtocolTests extends FunSuite {
  ...
  test("enumerated 1") {
    val protocol =
      new LabProtocol("", "", "", "", 1, true, true, 0, "", Nil,
  ...
  test("enumerated 2") {
    val protocol =
      new LabProtocol("enumerated2", "", "", "", 2, true, true, 0, "", Nil,
                   List(new EnumeratedValueSet("foo", List(1d, 2d, 3d))))
  ...
  test("enumerated 2_") {
    val protocol =
      new LabProtocol("enumerated2", "", "", "", 2, false, true, 0, "", Nil,
                   List(new EnumeratedValueSet("foo", List(1d, 2d, 3d))))
    assertResult(6)(protocol.countRuns)
  ...
  test("stepped 1") {
    val protocol = new LabProtocol("", "", "", "", 1, true, true, 0, "", Nil,
  ...
  test("stepped 2") {
    val protocol = new LabProtocol("stepped2", "", "", "", 10, true, true, 0, "", Nil,
                                List(new SteppedValueSet("foo", 1d, 1d, 5d)))
