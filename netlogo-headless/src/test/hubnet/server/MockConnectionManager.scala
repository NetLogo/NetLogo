...
import org.nlogo.api.{ HubNetWorkspaceInterface, HubNetInterface, PlotInterface, Workspace },
  HubNetInterface.ClientInterface
...
class MockConnectionManager(connection: ConnectionInterface, workspace: Workspace & HubNetWorkspaceInterface)
