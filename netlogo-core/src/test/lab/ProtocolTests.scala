...
class ProtocolTests extends FunSuite {
  ...
  test("enumerated 2") {
    val protocol =
      new LabProtocol("enumerated2", "", "", "", 2, true, true, 0, "", Nil, valueSet123)
  ...
  test("enumerated 2_") {
    val protocol =
      new LabProtocol("enumerated2", "", "", "", 2, false, true, 0, "", Nil, valueSet123)
    assertResult(6)(protocol.countRuns)
    assertResult("List((foo,1.0)) List((foo,2.0)) List((foo,3.0)) List((foo,1.0)) List((foo,2.0)) List((foo,3.0))")(
      protocol.refElements.mkString(" "))
  }
  test("stepped 1") {
    val protocol = new LabProtocol("", "", "", "", 1, true, true, 0, "", Nil, valueSet115)
    assertResult(5)(protocol.countRuns)
    assertResult("List((foo,1.0)) List((foo,2.0)) List((foo,3.0)) List((foo,4.0)) List((foo,5.0))")(
      protocol.refElements.mkString(" "))
  }
  test("stepped 2") {
    val protocol = new LabProtocol("stepped2", "", "", "", 10, true, true, 0, "", Nil, valueSet115)
