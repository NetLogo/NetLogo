...
class ProtocolTests extends AnyFunSuiteEx {
  ...
  test("enumerated 2") {
    val protocol =
      new LabProtocol("enumerated2", "", "", "", "", "", 2, true, true, "", 0, "", Nil, valueSet123, Nil)
  ...
  test("enumerated 2_") {
    val protocol =
      new LabProtocol("enumerated2", "", "", "", "", "", 2, false, true, "", 0, "", Nil, valueSet123, Nil)
    assertResult(6)(protocol.countRuns)
    assertResult("List((foo,1.0)) List((foo,2.0)) List((foo,3.0)) List((foo,1.0)) List((foo,2.0)) List((foo,3.0))")(
      protocol.refElements.mkString(" "))
  }
  test("stepped 1") {
    val protocol = new LabProtocol("", "", "", "", "", "", 1, true, true, "", 0, "", Nil, valueSet115, Nil)
    assertResult(5)(protocol.countRuns)
    assertResult("List((foo,1.0)) List((foo,2.0)) List((foo,3.0)) List((foo,4.0)) List((foo,5.0))")(
      protocol.refElements.mkString(" "))
  }
  test("stepped 2") {
    val protocol = new LabProtocol("stepped2", "", "", "", "", "", 10, true, true, "", 0, "", Nil, valueSet115, Nil)
  ...
  test("avoid floating point error") {
    val protocol = new LabProtocol("stepped3", "", "", "", "", "", 1, true, true, "", 0, "", Nil,
                                List(new SteppedValueSet("foo", 0.1d, 0.1d, 0.5d)), Nil)
  ...
  test("both") {
    def make(repetitions:Int) =
      new LabProtocol("both", "", "", "", "", "", repetitions, true, true, "", 0, "", Nil,
        valueSet123 :+ new SteppedValueSet("bar", 1d, 1d, 5d), Nil)
