...
object TokenMapping {
  ...
  val commandClassNames: Map[String, String] =
    Map( "__APPLY"                       -> "org.nlogo.core.prim.etc._apply"
       ...
       , "AUTOPLOT-OFF"                  -> "org.nlogo.core.prim.etc._autoplotoff"
       , "AUTO-PLOT-ON"                  -> "org.nlogo.core.prim.etc._autoploton"
       , "AUTOPLOT-ON"                   -> "org.nlogo.core.prim.etc._autoploton"
       , "AUTO-PLOT-X-OFF"               -> "org.nlogo.core.prim.etc._autoplotxoff"
       , "AUTOPLOT-X-OFF"                -> "org.nlogo.core.prim.etc._autoplotxoff"
       , "AUTO-PLOT-X-ON"                -> "org.nlogo.core.prim.etc._autoplotxon"
       , "AUTOPLOT-X-ON"                 -> "org.nlogo.core.prim.etc._autoplotxon"
       , "AUTO-PLOT-Y-OFF"               -> "org.nlogo.core.prim.etc._autoplotyoff"
       , "AUTOPLOT-Y-OFF"                -> "org.nlogo.core.prim.etc._autoplotyoff"
       , "AUTO-PLOT-Y-ON"                -> "org.nlogo.core.prim.etc._autoplotyon"
       , "AUTOPLOT-Y-ON"                 -> "org.nlogo.core.prim.etc._autoplotyon"
  ...
  val reporterClassNames: Map[String, String] =
    Map( "!="                            -> "org.nlogo.core.prim._notequal"
       ...
       , "AUTOPLOT-X?"                   -> "org.nlogo.core.prim.etc._autoplotx"
       , "AUTOPLOTY?"                    -> "org.nlogo.core.prim.etc._autoploty"
       , "AUTOPLOT-Y?"                   -> "org.nlogo.core.prim.etc._autoploty"
       ...
       , "IS-ARROW-COMMAND?"             -> "org.nlogo.core.prim.etc._isanonymouscommand"
       , "IS-ANONYMOUS-REPORTER?"        -> "org.nlogo.core.prim.etc._isanonymousreporter"
       , "IS-ARROW-REPORTER?"            -> "org.nlogo.core.prim.etc._isanonymousreporter"
