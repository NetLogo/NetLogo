...
import org.nlogo.core,
  core.{AstVisitor, Fail, Instruction,
    ...
    prim.{_reportertask, _commandtask, _call, _callreport, _commandlambda, _reporterlambda, _task},
    Fail._
...
class AgentTypeChecker(defs: Seq[ProcedureDefinition]) {
  ...
  class AgentTypeCheckerVisitor(var agentClassString: String) extends AstVisitor {
    ...
    override def visitReporterApp(app: ReporterApp) {
      ...
      if (r.isInstanceOf[_commandtask] || r.isInstanceOf[_reportertask] || r.isInstanceOf[_commandlambda] || r.isInstanceOf[_reporterlambda])
      ...
      r match {
        case (_: _commandtask | _: _reportertask | _: _commandlambda | _: _reporterlambda) =>
