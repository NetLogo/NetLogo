...
![Plot Editor](file:./images/interface/plot.gif)
...
In the Plot setup commands field you can enter commands that will be run when the `reset-ticks` or `setup-plots` commands are run. Click the little triangle to open up the a text box the enter the commands. Plot update commands are explained in more detail in the Plotting Section of the Programming Guide.

In the Plot update commands field you can enter commands that will be run when the `tick` or `update-plots` commands are run. Click the little triangle to open up the a text box the enter the commands. Plot setup commands are explained in more detail in the Plotting Section of the Programming Guide.
...
* To edit the pen's name, double click the name and type in a new name. 
* In the Update commands column you can enter a command that will be run when the `tick` or `update-plots` commands are run. This is explained in more detail in the Plotting Section of the Programming Guide.
* The last column has two buttons. Clicking the pencil button will bring up the advanced settings dialog for the pen. The advanced settings dialog is explained below. Clicking the trash can button will delete the pen.

##### Plot Pen Advanced Settings #####

Clicking the pencil button for a particular pen will bring up this dialog:

![Plot Editor](file:./images/interface/plot-pen-advanced.gif)
...
* In the Setup commands field you can enter a command that will be run when the `reset-ticks` or `setup-plots` commands are run. This is explained in more detail in the Plotting Section of the Programming Guide.
* In the Update commands field you can enter a command that will be run when the `tick` or `update-plots` commands are run. This field appears in the advanced dialog to give more space for more complicated code. This is explained in more detail in the Plotting Section of the Programming Guide.
