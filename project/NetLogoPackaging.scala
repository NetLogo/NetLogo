...
object NetLogoPackaging {
  ...
  val behaviorsearchProject = ProjectRef(uri(System.getProperty("behaviorsearch.uri", "git://github.com/NetLogo/behaviorsearch.git#wip-60-integration")), "behaviorsearch")
