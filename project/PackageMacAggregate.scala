...
object PackageMacAggregate {
  ...
  , launchers: Seq[Launcher]
    ...
    val jarLibsToSign = Map(
      ("app/flatlaf-3.4.jar", Seq("com/formdev/flatlaf/natives/libflatlaf-macos-x86_64.dylib", "/com/formdev/flatlaf/natives/libflatlaf-macos-arm64.dylib"))
    , ("app/jna-4.2.2.jar", Seq("com/sun/jna/darwin/libjnidispatch.jnilib"))
    ...
    , ("extensions/.bundled/vid/bridj-0.7-20140918-3.jar", Seq("org/bridj/lib/darwin_universal/libbridj.dylib"))
