...
object PackageLinuxAggregate {
  ...
  , launchers: Seq[Launcher]
    ...
    log.info("Creating NetLogo Console sym link")
    FileActions.createRelativeSoftLink(appImageDir / "NetLogo Console", appImageDir / "bin" / "NetLogo")
    ...
    NetLogoPackaging.generateChecksums(log, version, arch, versionedAppImageDir.toPath, webDir.getParentFile.toPath)
