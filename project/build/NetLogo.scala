...
class NetLogo(info: ProjectInfo) extends DefaultProject(info)
  ...
  override def javaCompileOptions =
    "-bootclasspath dist/java5/classes.jar:dist/java5/ui.jar:dist/java5/plugin.jar -g -deprecation -encoding us-ascii -Werror -Xlint:all -Xlint:-serial -Xlint:-fallthrough -Xlint:-path -source 1.5 -target 1.5"
