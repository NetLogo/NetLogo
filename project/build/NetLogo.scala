...
class NetLogo(info: ProjectInfo) extends DefaultProject(info)
  ...
  override def compileAction = super.compileAction dependsOn(autogen, copyResourcesAction, java5)
  override def compileOptions =
    "-unchecked -Xfatal-warnings -encoding us-ascii -Xcheckinit -deprecation"
