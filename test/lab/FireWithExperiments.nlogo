...
false
0
Polygon -7566196 true true 151 1 185 108 298 108 207 175 242 282 151 216 59 282 94 175 3 108 116 108
...
@#$#@#$#@
<experiments>
  <experiment name="test1" runMetricsEveryTick="false">
    <setup>random-seed 473 setup</setup>
    <go>go</go>
    <timeLimit ticks="50"/>
    <metric>burned-trees</metric>
  </experiment>
  <experiment name="test2" runMetricsEveryTick="false">
