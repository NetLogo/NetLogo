...
class LiteralParserTests extends FunSuite with MockSuite {
  ...
  test("booleans") {
    expect(java.lang.Boolean.TRUE)(toLiteral("true"))
    expect(java.lang.Boolean.FALSE)(toLiteral("false"))
  }
  test("literalInt") { expect(Double.box(4))(toLiteral("4")) }
  test("literalIntWhitespace") { expect(Double.box(4))(toLiteral("  4\t")) }
  test("literalIntParens") { expect(Double.box(4))(toLiteral(" (4)\t")) }
  test("literalIntParens2") { expect(Double.box(4))(toLiteral(" ((4)\t)")) }
  ...
  test("literalString") { expect("hi there")(toLiteral("\"hi there\"")) }
  test("literalList") { expect("[1 2 3]")(Dump.logoObject(toLiteralList("[1 2 3]"))) }
  test("literalList2") { expect("[1 [2] 3]")(Dump.logoObject(toLiteralList("[1 [2] 3]"))) }
  test("literalList3") { expect("[[1 2 3]]")(Dump.logoObject(toLiteralList("[[1 2 3]]"))) }
  test("literalList4") { expect("[1 hi true]")(Dump.logoObject(toLiteralList("[1 \"hi\" true]"))) }
  test("literalList5") { expect("[[1 hi true]]")(Dump.logoObject(toLiteral("([([1 \"hi\" true])])"))) }
  test("parseLiteralList") { expect("[1 2 3]")(Dump.logoObject(toLiteralList("[1 2 3]"))) }
  test("parseLiteralList2a") { expect("[1 [2] 3]")(Dump.logoObject(toLiteralList("[1 [2] 3]"))) }
  test("parseLiteralList2b") { expect("[[1] [2] [3]]")(Dump.logoObject(toLiteralList("[[1] [2] [3]]"))) }
  test("parseLiteralList3") { expect("[[1 2 3]]")(Dump.logoObject(toLiteralList("[[1 2 3]]"))) }
  test("parseLiteralList4") { expect("[1 hi true]")(Dump.logoObject(toLiteralList("[1 \"hi\" true]"))) }
